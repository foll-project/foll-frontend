      ...
      <div className="bg-[#FCF9F0] rounded-xl shadow-2xl flex w-full max-w-[900px] overflow-hidden min-h-[500px]">
        ...
        <div className="w-1/2 px-12 py-10 flex flex-col bg-[#FCF9F0]">
          ...
          <div className="flex-1 flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-[#16333F] mb-1">{t('auth.welcomeBack')}</h2>
            ...
            <form onSubmit={handleLogin} className="space-y-5 flex-1">
              <div>
                <label className="block text-xs font-bold text-[#16333F] mb-1.5 ml-1">{t('auth.email')}</label>
              ...
              <div>
                <label className="block text-xs font-bold text-[#16333F] mb-1.5 ml-1">{t('auth.password')}</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <div className="flex justify-end mt-2"><a href="#" className="text-[10px] font-bold text-[#4A697A] hover:text-[#16333F] hover:underline">{t('auth.forgotPassword')}</a></div>
              </div>
